...
<html>
	<head>
		...
		<title>EDP - Extended Driver Package</title>
		<script>var activepage = 'none';</script>
	</head>
...
<?php include "navbar.inc.php"; ?>
		...
		<div 	id="console_container"  	class="console_container">
			<div id="console_topbar" 		class="console_topbar">
				<div id="console_topbar_title" class="console_topbar_title">Welcome to EDPweb</div>
			</div>
