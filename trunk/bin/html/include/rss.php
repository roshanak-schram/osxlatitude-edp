...
// step 1: get the feed
//$blog_url = "http://argo.osxlatitude.com/edprss/rss.php";
$blog_url = "http://pipes.yahoo.com/pipes/pipe.run?_id=fcf8f5975800dd5f04a86cdcdcef7c4d&_render=rss";
...
foreach ($xml->channel->item as $item)
{
        ...
        $desc = $article["description"] = (string) trim($item->description);
